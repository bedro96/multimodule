...
module "virtual_network" {
    ...
    virtual_network_group_location      = module.resource_group.resource_group_location
}

module "ubuntu-machine"{
    source                              = "./modules/ubuntu-machine"
    ubuntu_resource_group_name          = module.resource_group.resource_group_name
    ubuntu_resource_group_location      = module.resource_group.resource_group_location
    ubuntu_server_subnet_id             = module.virtual_network.server_subnet_id
}
